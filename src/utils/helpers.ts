import { ChatMessage, GroupedSearchHistories, SearchableChatHistories, SearchableChatHistory } from '../types';
...
const extractTextContent = (msg: ChatMessage): string => {
...
/**
 * Removes initial system message and any subsequent ones (used to prompt secondary model for image summarization)
 */
